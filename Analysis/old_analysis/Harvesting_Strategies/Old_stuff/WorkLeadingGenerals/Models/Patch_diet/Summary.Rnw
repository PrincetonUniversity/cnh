...
<<echo=FALSE,results='markup',message=FALSE,warning=FALSE,wrap = 'div', out.extra="",fig.width=7,fig.height=5>>=
...
<<echo=FALSE,results='markup',message=FALSE,warning=FALSE,fig.width=4>>=
...
<<message=FALSE,warning=FALSE,echo=F,fig.width=6,fig.align='center',fig.height=5,fig.width=5,out.extra='style="display:block;"'>>=
