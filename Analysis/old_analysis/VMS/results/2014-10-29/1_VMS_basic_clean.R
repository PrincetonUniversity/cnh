...
library(plyr); library(maptools); library(rgeos); library(rgdal); library(data.table)
...
saveRDS(VMS,"/Users/efuller/1/CNH/Analysis/VMS/results/2014-10-29/VMS_basic_clean.RDS" )
