...
agreement <- function (gear, year) {
  df10 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-10-08/predicted_metiers/2010/2010p",gear, year,".RDS"))
  df12 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-10-08/predicted_metiers/2012/2012p",gear, year,".RDS"))
...
saveRDS(ARI, "/Users/efuller/1/CNH/Analysis/Metiers/results/2014-10-08/adjustRandIndex.RDS")
