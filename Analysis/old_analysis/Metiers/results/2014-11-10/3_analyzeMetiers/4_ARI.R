...
agreement <- function (gear, year) {
  df10 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-10/2_defineMetiers/classify_metiers/modified/2010/2010p",gear, year,".RDS"))
  df12 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-10/2_defineMetiers/classify_metiers/modified/2012/2012p",gear, year,".RDS"))
...
classAgreement(agreement("NET",2013))$crand
classAgreement(agreement("POT",2009))$crand

# now HKL is awful


grgroups <- c("TLS","TWS","TWL","POT","NET","HKL","MSC")
grgroups <- c("TLS","TWS","POT","NET","HKL","MSC")
...
TWL <- c(classAgreement(agreement("TWL",2009))$crand, NA, classAgreement(agreement("TWL",2013))$crand)
ARI <- rbind(ARI, TWL)
saveRDS(ARI, "/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-10/3_analyzeMetiers/adjustRandIndex.RDS")
