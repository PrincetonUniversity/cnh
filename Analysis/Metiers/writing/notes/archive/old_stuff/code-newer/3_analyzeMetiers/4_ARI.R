...
agreement <- function (gear, year) {
  df10 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/writing/code/2_defineMetiers/2010p",gear, year,".RDS"))
  df12 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/writing/code/2_defineMetiers/2012p",gear, year,".RDS"))
...
saveRDS(ARI, "/Users/efuller/1/CNH/Analysis/Metiers/writing/code/3_analyzeMetiers/adjustRandIndex.RDS")
