...
#### Next steps
I haven't compared this to network-level measures such as effective connectance. I wonder how it would stack up against the mean port-level diversity. It might be in-between the vessel and trip aggregated measures since it takes number of nodes, but also their connectivity into account. I should do this. 