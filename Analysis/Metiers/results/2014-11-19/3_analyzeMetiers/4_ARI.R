...
agreement <- function (gear, year) {
  df10 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-19/classify_metiers/modified/2010/2010p",gear, year,".RDS"))
  df12 <- readRDS(paste0("/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-19/classify_metiers/modified/2012/2012p",gear, year,".RDS"))
...
classAgreement(agreement("MSC",2009))$crand
...
grgroups <- c("TLS","TWS","NET","MSC","TWL")
...
ARI <- rbind(ARI, TWL)
saveRDS(ARI, "/Users/efuller/1/CNH/Analysis/Metiers/results/2014-11-19/3_analyzeMetiers/adjustRandIndex.RDS")
