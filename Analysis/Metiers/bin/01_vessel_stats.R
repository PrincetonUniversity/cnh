...
# flags: alaska, ifq participation, california halibut participation ----
    ak <- read.csv("/Users/efuller/Desktop/CNH/Analysis/Metiers/data/WC_drvids_alaska.csv",stringsAsFactors = FALSE)
...
# save data ----    
    saveRDS(vessel_stats, "/Users/efuller/Desktop/CNH/Analysis/Metiers/bin/04_data_output/vessel_stats.RDS")
    return(vessel_stats)
  }