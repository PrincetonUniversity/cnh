...
120816: running lines 233-266 now. if that works, need to make files for each individual vessel (vessel_tracks), remove sequential on-land points and abnormally high speeds, and then makes clean individual files for each trip for each vessel (fish_tracks)
