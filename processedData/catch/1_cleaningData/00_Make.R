...
source("/Users/efuller/1/CNH/processedData/catch/1_cleaningData/01_incomeFilter.R")
...
# filter for rarely caught species ----
  source("/Users/efuller/1/CNH/processedData/catch/1_cleaningData/02_filter_rare.R")
  ftl_major <- filter_rare(data = ftl)
  saveRDS(ftl_major, "/Users/efuller/1/CNH/processedData/catch/1_cleaningData/filtered_ftl.RDS")
...
# combine clustering results with filtered ticket data, requires directory 2_defineMetiers has infoMap results
  source("/Users/efuller/1/CNH/processedData/catch/1_cleaningData/03_sewTrips.R")
  ...
  d12 <- readRDS("/Users/efuller/1/CNH/processedData/catch/1_cleaningData/tickets_2012.RDS")
  ...
  saveRDS(tickets, "/Users/efuller/1/CNH/processedData/catch/1_cleaningData/tickets.RDS")
