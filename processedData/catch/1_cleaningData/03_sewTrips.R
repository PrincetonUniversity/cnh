...
# load data ----
filtered_ftl <- readRDS("/Users/efuller/Desktop/CNH/processedData/catch/1_cleaningData/filtered_ftl.RDS")

files <- list.files("/Users/efuller/Desktop/CNH/processedData/catch/2_defineMetiers/") # load 2010 predicted metiers
...
if(base_year == 2010){
  ...
  # load files
  predicteds <- do.call(rbind, lapply(paste0("/Users/efuller/Desktop/CNH/processedData/catch/2_defineMetiers/",pred_files), read.csv,stringsAsFactors = FALSE))
...
# classified trips
  ...
  classifieds <- do.call(rbind, lapply(paste0("/Users/efuller/Desktop/CNH/processedData/catch/2_defineMetiers/", class_files), readRDS))
...
# merge metiers ----
  ...
  saveRDS(tickets, paste0("/Users/efuller/Desktop/CNH/processedData/catch/1_cleaningData/tickets_",base_year,".RDS"))
#----
return(tickets)
}